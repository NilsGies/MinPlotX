...
function [StrctFrm, apfu,options_definition]=chloritoid_MinPlotX(data,headers,options)
...
%Parameter 1
options_definition.want_ferric_Fe3.question='Do you want to consider Fe3';
options_definition.want_ferric_Fe3.Value=true;
...
%if options.want_ferric_Fe3.Value==true
if isfield(options,'want_ferric_Fe3') && options.want_ferric_Fe3.Value==true 
    ...
    if isfield(options,'UseKnownFe3') && options.UseKnownFe3.Value==true
        [StrctFrm, apfu]=chloritoid_Fe3known(data,headers,options);
    else
        [StrctFrm, apfu]=chloritoid_Fe3unknown(data,headers,options);
    end
else
